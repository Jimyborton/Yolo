...
MODEL_SPECS = {
    "mobilenet_ssd": {
        ...
        "prototxt_urls": [
            # Copia mantenida por la comunidad (raw=1 asegura descarga directa).
            "https://github.com/chuanqi305/MobileNet-SSD/blob/master/MobileNetSSD_deploy.prototxt?raw=1",
            # Espejo alternativo en Hugging Face para evitar errores 404 intermitentes.
            "https://huggingface.co/datasets/keremberke/ssd-mobilenet-voc/resolve/main/MobileNetSSD_deploy.prototxt",
            # Espejo adicional en GitHub Gist.
            "https://gist.githubusercontent.com/soham96/9e48d0bba2c9c56969bab3cdd567be03/raw/MobileNetSSD_deploy.prototxt",
        ],
        "weights_urls": [
            # Pesos originales liberados por los autores.
            "https://github.com/chuanqi305/MobileNet-SSD/raw/master/MobileNetSSD_deploy.caffemodel",
            # Espejo alternativo en Hugging Face.
            "https://huggingface.co/datasets/keremberke/ssd-mobilenet-voc/resolve/main/MobileNetSSD_deploy.caffemodel",
            # Espejo adicional en GitHub Gist.
            "https://gist.githubusercontent.com/soham96/9e48d0bba2c9c56969bab3cdd567be03/raw/MobileNetSSD_deploy.caffemodel",
        ],
        "labels": MODEL_LABELS,
    },
}
